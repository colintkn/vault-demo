...
$username   = file_get_contents("/vault/secrets/static_secret_0_username");
$password   = file_get_contents("/vault/secrets/static_secret_0_password");
$apikey   = file_get_contents("/vault/secrets/static_secret_0_apikey");
